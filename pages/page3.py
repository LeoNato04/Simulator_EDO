...
dash.register_page(
    ...
    name='Ley de Enfriamiento y Calentamiento'
)
...
layout = html.Div(className='Pages', children=[
    ...
    html.Div(className='div_parametros', children=[
        ...
        # Texto explicativo
        html.Div(className='descripcion', children=[
            html.P('Ley de Enfriamiento: Temperatura Inicial > Temperatura Ambiente'),
            html.P('Ley de Calentamiento: Temperatura Inicial < Temperatura Ambiente')
        ]),
    ...
    html.Div(className='div_grafica', children=[
        html.H2('GRÁFICA DE LA LEY DE ENFRIAMIENTO Y CALENTAMIENTO'),
        dcc.Loading(
            type='default',
